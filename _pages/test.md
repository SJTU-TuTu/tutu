...
<i class="fa fa-weixin" style="font-size:48px;color:red"></i>


<h2 style="border-bottom:1px solid #ddd">按钮中使用</h2>

<button style="font-size:22px">按钮 <i class="fa fa-weixin"></i></button>

<h3 style="border-bottom:1px solid #ddd">Unicode</h3>
